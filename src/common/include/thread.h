...
extern int createThreadEtc(thread_func_t entryFunction,
                                  void *userData,
...
extern thread_id_t getThreadId();
...
extern int setThreadSchedulingGroup(pid_t tid, int grp);

// Change the priority AND scheduling group of a particular thread.  The priority
// should be one of the ANDROID_PRIORITY constants.  Returns INVALID_OPERATION
// if the priority set failed, else another value if just the group set failed;
// in either case errno is set.  Thread ID zero means current thread.
extern int setThreadPriority(pid_t tid, int prio);

// Get the current priority of a particular thread. Returns one of the
// ANDROID_PRIORITY constants or a negative result in case of error.
extern int getThreadPriority(pid_t tid);
...
extern int getThreadSchedulingGroup(pid_t tid);

extern int set_sched_policy(pid_t tid, const SchedPolicy & policy);
extern int get_sched_policy(pid_t tid, SchedPolicy* policy);
